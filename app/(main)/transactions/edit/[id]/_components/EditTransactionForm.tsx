...
export function EditTransactionForm({
    ...
    const onSubmit = async (data: z.infer<typeof updateTransactionSchema>) => {
        ...
        try {
            ...
            if (data.amount !== undefined) cleanedData.amount = data.amount;
            if (data.transactionType !== undefined) cleanedData.transactionType = data.transactionType;
            if (data.status !== undefined) cleanedData.status = data.status;
            if (data.date !== undefined) {
                cleanedData.date = data.date instanceof Date
            ...
            if (data.currency !== undefined) cleanedData.currency = data.currency;
            if (data.isActive !== undefined) cleanedData.isActive = data.isActive;
            if (data.bankAccountId !== undefined) cleanedData.bankAccountId = data.bankAccountId || null;
            if (data.categoryId !== undefined) cleanedData.categoryId = data.categoryId || null;
            if (data.subCategoryId !== undefined) cleanedData.subCategoryId = data.subCategoryId || null;
            if (data.paymentMethod !== undefined) cleanedData.paymentMethod = data.paymentMethod || null;
