 ...
 * Dialog for creating a new transaction with modern UI
 */
export function AddTransactionDialog({
    ...
    // Find the first active bank account
    const activeBankAccount = useMemo(() => {
        return bankAccounts.find((acc) => acc.isActive) || bankAccounts[0] || null;
    }, [bankAccounts]);
    ...
    const {
        ...
        defaultValues: {
            ...
            currency: "INR",
            isActive: true,
            bankAccountId: activeBankAccount?.id || null,
            categoryId: null,
            subCategoryId: null,
            paymentMethod: null,
        },
            ...
            <DialogContent className="max-w-2xl md:min-w-2xl max-h-[90vh] overflow-hidden flex flex-col p-0 rounded-2xl shadow-2xl" showCloseButton={false}>
                ...
                <div className="flex items-center justify-between p-6 border-b border-border bg-muted/20">
                    <div className="flex flex-col">
                        <span className="text-2xl font-bold tracking-tight">Add Transaction</span>
                            ...
                            <div className="flex items-center gap-3">
                                <div className="relative flex-1">
                                    ...
                                    <input
                                        ...
                                        className={`w-full bg-transparent text-5xl font-bold placeholder:text-muted/50 focus:outline-none pl-10 py-2 border-0 focus-visible:ring-0 ${errors.amount ? "text-red-500" : ""}`}
                                    />
                                </div>
                                <Select
                                    value={currencyValue}
