...
export default function AddAssetPage() {
  ...
  const {
    ...
    setValue,
    watch,
  } = useForm<z.infer<typeof addAssetSchema>>({
  ...
  const onSubmit = async (data: z.infer<typeof addAssetSchema>) => {
        ...
        <CardContent>
          ...
          >
            ...
            <div className="flex flex-col space-y-2">
              ...
              <Select
                defaultValue="OTHER"
                onValueChange={(value) => setValue("type", value as z.infer<typeof addAssetSchema>["type"], { shouldValidate: true })}
              >
                <SelectTrigger>
            ...
            <div className="flex flex-col space-y-2">
              ...
              <Select
                defaultValue=""
                onValueChange={(value) =>
                  setValue("paymentMethod", value ? (value as z.infer<typeof addAssetSchema>["paymentMethod"]) : null, {
                    shouldValidate: true,
                  })
                }
              >
            ...
            <div className="flex flex-col space-y-2">
              ...
              <Select
                defaultValue=""
                onValueChange={(value) =>
                  setValue("transactionStatus", value ? (value as z.infer<typeof addAssetSchema>["transactionStatus"]) : null, {
                    shouldValidate: true,
                  })
                }
              >
