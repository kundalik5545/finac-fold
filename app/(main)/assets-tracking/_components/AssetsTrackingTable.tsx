...
export function AssetsTrackingTable({ assets }: { assets: Asset[] }) {
    ...
    const handleEdit = (e: React.MouseEvent, assetId: string) => {
        e.stopPropagation();
            ...
            <Table className={isMobile ? "w-full" : "min-w-[800px]"}>
                ...
                <TableHeader>
                    <TableRow>
                        ...
                        {!isMobile && (
                            <TableHead className="text-sm">Purchase Date</TableHead>
                        )}
                        {!isMobile && (
                            <TableHead className="text-sm">Purchase Value</TableHead>
                        )}
                                ...
                                <TableCell className="text-right">
                                    <div className="flex items-center justify-end gap-2">
                                        <Button
                                            variant="ghost"
                                            size="sm"
                                            onClick={(e) => handleEdit(e, asset.id)}
                                        >
                                            <Edit size={16} />
                                        </Button>
                                        <Button
